...
contract('ToDoList',(accounts)=>{
  ...
  // check wheather the task are added or removed correctly form completed list
  it('Check wheather the task are added or removed correctly and toggled in completed list',async()=>{
